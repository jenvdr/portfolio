                            ...
                            <div className='h-full flex flex-col lg:justify-center max-lg:pt-9'>
                                <Prose className="max-w-full text-center flex flex-col lg:justify-between max-lg:gap-3 lg:mt-8 prose-ul:list-none prose-li:text-2xl prose-li:lg:text-4xl prose-li:font-primary prose-li:p-0 prose-a:no-underline text-red prose-a:text-red ">
                                    <ul className='flex gap-5 lg:gap-10 justify-center'>
                                        <li><Link aria-label="Email" title="Email" className='focus:ring-1 focus:ring-red focus:ring-offset-4 outline-none rounded-[22px] rounded-tl-none hover:text-blue transition-colors duration-300 ease-in-out' href="mailto:jvobisdev@gmail.com" target="_blank">Email</Link></li>
                                        <li><Link aria-label="Linkedin" title="Linkedin" className='focus:ring-1 focus:ring-red focus:ring-offset-4 outline-none rounded-[22px] rounded-tl-none hover:text-blue transition-colors duration-300 ease-in-out' href="https://www.linkedin.com/in/jennifer-vobis" target="_blank">LinkedIn</Link></li>
                                        <li><Link aria-label="Github" title="Github" className='focus:ring-1 focus:ring-red focus:ring-offset-4 outline-none rounded-[22px] rounded-tl-none hover:text-blue transition-colors duration-300 ease-in-out' href="https://github.com/jenvdr" target="_blank">GitHub</Link></li>
                                    </ul>
