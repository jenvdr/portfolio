                        ...
                        <div className="w-full h-[60vh] pt-[180px] pb-[112px] lg:col-span-6 lg:col-start-4 flex flex-col justify-center gap-8">
                            ...
                            <Prose className={`lg:translate-x-1/4`}>
                                <p className="text-white fade-in">
                                    In my home country of Germany we say
                                    'Aufwiedersehen' which means 'until we see
                                    each other again', so if you like my work
                                    and have a cool project you'd like to chat
                                    about please don't hesitate to reach out to
                                    me. Below are some ways you can contact me.
                                    Thank you and Aufwiedersehen!
                                </p>
                            </Prose>
                        </div>
                    </div>
                                    ...
                                    <ul className="flex gap-5 lg:gap-10 justify-center">
                                        <li>
                                            <Link
                                                aria-label="Email"
                                                title="Email"
                                                className="focus:ring-1 focus:ring-red focus:ring-offset-4 outline-none rounded-[22px] rounded-tl-none hover:text-blue transition-colors duration-300 ease-in-out"
                                                href="mailto:jvobisdev@gmail.com"
                                                target="_blank"
                                            >
                                                Email
                                            </Link>
                                        ...
                                        <li>
                                            <Link
                                                ...
                                                title="Linkedin"
                                                className="focus:ring-1 focus:ring-red focus:ring-offset-4 outline-none rounded-[22px] rounded-tl-none hover:text-blue transition-colors duration-300 ease-in-out"
                                                href="https://www.linkedin.com/in/jennifer-vobis"
                                                target="_blank"
                                            >
                                                LinkedIn
                                            </Link>
