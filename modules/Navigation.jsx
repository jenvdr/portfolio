...
export default function Navigation({
    ...
    useEffect(() => {
        ...
        timeline.fromTo(
            ...
            { opacity: 1, x: "40px", y: "96px", duration: 0.5 },
            "<"
        );
        ...
        const checkOverlap = () => {
            ...
            sections.forEach((section) => {
                ...
                if (
                    ...
                    setInvert(
                        section.classList.contains("bg-yellow") &&
            ...
            <div className="trigger relative z-10">
                <div className="flex items-center justify-between gap-3">
                    ...
                    <div className="relative md:w-[60px]">
                        <span className="opacity-0 tracking-widest">
                            {activeSection}
                        </span>
                        <span
                            className="fade-in absolute inset-0 tracking-widest"
                            ref={sectionRef}
                        >
                            {activeSection}
                        </span>
            ...
            >
                {availableSections.map((section, index) => {
                    ...
                    return (
                        <li
                            key={section}
                            className={`group-data-[invert=true]:!bg-white/45 group-data-[invert=true]:group-hover:md:!bg-white md:px-3 py-1 rounded-md max-md:text-right`}
                            data-index={index}
                        >
                            <Link
                                aria-label={section}
