        ...
        extend: {
            keyframes: {
                ...
                "going-for-a-walk": {
                    ...
                    "34%": { transform: "translateY(400px)" },
                    "66%": { transform: "translateX(-250px)" },
                    "67%": { transform: "translate(-250px, 0)" },
                    "100%": { transform: "translateX(0)" },
                },
            },
            animation: {
                topRotate: "top-rotation 0.3s ease-in-out infinite",
                bottomRotate: "bottom-rotation 0.3s ease-in-out infinite",
                goodbye: "going-for-a-walk 1.5s ease-in-out",
            },
            maxWidth: {
                "7xl": "75rem",
            },
